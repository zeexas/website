...
export const projects = [
  {
    ...
    svg: ComingSoon,
    about: `Web application for a private dermatology clinic — patient management and visit tracking,
    appointment scheduling and reporting`,
    about_ru: `Приложение для частной дерматологической клиники - учет пациентов и их посещений, 
    календарь записей на прием и отчетность`,
    tech_stack:
      'HTML, CSS, Next, TypeScript, Zustand, MUI, Flask (Python), Postgres, Docker, Railway (deploy), AWS S3',
    url: '',
    code: '',
  },
  {
