    ...
    <div className="w-full h-full flex justify-center items-center">
      <div className="w-[65%] h-[50%] flex flex-col text-teal-700 text-[1.3rem]">
        ...
        {!aboutTech ? <section className="w-[80%] mt-8">
          ...
          My latest achivements: ~ created full-stack app prototype for financial company ~ ran a half marathon in Almaty (april, 2023)
        </section> :
        <section className='flex flex-col mt-8 gap-10'>
          <div>
            <div>Technologies I use for creating web applications</div>
            <div className={iconBlock}>
              <a href='https://developer.mozilla.org/en-US/docs/Web/HTML' target='_blanc'>
                <img src={Html} alt="html-5 logo" title='html' className={iconStyle} />
              </a>
              <a href='https://developer.mozilla.org/en-US/docs/Web/CSS' target='_blanc'>
                <img src={Css} alt="css-3 logo" title='css' className={iconStyle} />
              </a>
              <a href='https://sass-lang.com/' target='_blanc'>
                <img src={Sass} alt="sass logo" title='sass' className={iconStyle} />
              </a>
              <a href='https://tailwindcss.com/' target='_blanc'>
                <img src={Tailwind} alt="tailwindcss logo" title='tailwindcss' className={iconStyle} />
              </a>
              <a href='https://mui.com/' target='_blanc'>
                <img src={MaterialUI} alt="material-ui logo" title='material-ui' className={iconStyle} />
              </a>
              <a href='https://getbootstrap.com/' target='_blanc'>
                <img src={Bootstrap} alt="bootstrap logo" title='bootstrap' className={iconStyle} />
              </a>
              <a href='https://developer.mozilla.org/en-US/docs/Web/JavaScript' target='_blanc'>
                <img src={Javascript} alt="javascript logo" title='javascript' className={iconStyle} />
              </a>
              <a href='https://www.typescriptlang.org/' target='_blanc'>
                <img src={Typescript} alt="typescript logo" title='typescript' className={iconStyle} />
              </a>
              <a href='https://react.dev/' target='_blanc'>
                <img src={Reactlogo} alt="react logo" title='react' className={iconStyle} />
              </a>
              <a href='https://redux.js.org/' target='_blanc'>
                <img src={Reduxlogo} alt="redux logo" title='redux' className={iconStyle} />
              </a>
              <a href='https://nextjs.org/' target='_blanc'>
                <img src={Next} alt="next.js logo" title='next.js' className={iconStyle} />
              </a>
              <a href='https://vuejs.org/' target='_blanc'>
                <img src={Vuelogo} alt="vue logo" title='vue' className={iconStyle} />
              </a>
            </div>
            <div className={iconBlock}>
              <a href='https://www.npmjs.com/' target='_blanc'>
                <img src={Npm} alt="npm logo" title='npm' className={iconStyle} />
              </a>
              <a href='https://yarnpkg.com/' target='_blanc'>
                <img src={Yarn} alt="yarn logo" title='yarn' className={iconStyle} />
              </a>
              <a href='https://git-scm.com/' target='_blanc'>
                <img src={Git} alt="git logo" title='git' className={iconStyle} />
              </a>
              <a href='https://github.com/' target='_blanc'>
                <img src={Github} alt="github logo" title='github' className={iconStyle} />
              </a>
              <a href='https://code.visualstudio.com/' target='_blanc'>
                <img src={VScode} alt="vscode logo" title='vscode' className={iconStyle} />
              </a>
              <a href='https://www.figma.com/' target='_blanc'>
                <img src={Figma} alt="figma logo" title='figma' className={iconStyle} />
              </a>
              <a href='https://www.postgresql.org/' target='_blanc'>
                <img src={Postgresql} alt="postgresql logo" title='postgresql' className={iconStyle} />
              </a>
              <a href='https://strapi.io/' target='_blanc'>
                <img src={Strapi} alt="strapi logo" title='strapi' className={iconStyle} />
              </a>
              <a href='https://nestjs.com/' target='_blanc'>
                <img src={Nest} alt="nest.js logo" title='nest.js' className={iconStyle} />
              </a>
              <a href='https://www.postman.com/' target='_blanc'>
                <img src={Postman} alt="postman logo" title='postman' className={iconStyle} />
              </a>
              <a href='https://www.prisma.io/' target='_blanc'>
                <img src={Prisma} alt="prisma logo" title='prisma' className={iconStyle} />
              </a>
              <a href='https://nodejs.org/' target='_blanc'>
                <img src={Nodejs} alt="nodejs logo" title='nodejs' className={iconStyle} />
              </a>
              <a href='https://webpack.js.org/' target='_blanc'>
                <img src={Webpack} alt="webpack logo" title='webpack' className={iconStyle} />
              </a>
              <a href='https://vitejs.dev/' target='_blanc'>
                <img src={Vite} alt="vite logo" title='vite' className={iconStyle} />
              </a>
              <a href='https://stripe.com/' target='_blanc'>
                <img src={Stripe} alt="stripe logo" title='stripe' className={iconStyle} />
              </a>
            </div>
          </div>
        </section>}
        <div className='w-fit flex flex-row gap-16 items-center mt-16'>
